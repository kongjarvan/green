...
<div class="container">
	<form><!-- onsubmit이 false를 리턴하면 action이 실행되지 않음 -->
		...
		<div class="mb-3">
			<input id="checkPassword" type="password" class="form-control" placeholder="confirm password" maxlength="20">
		</div>
		<div class="mb-3">
			<input id="email" type="text" class="form-control" placeholder="Enter email" maxlength="50">
		</div>
